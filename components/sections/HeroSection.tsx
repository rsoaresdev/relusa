...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            {/* Features Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 pt-6 max-w-2xl mx-auto">
              {[
                {
                ...
                <div
                  key={index}
                  className={`group relative p-3 md:p-4 rounded-2xl bg-white/80 backdrop-blur-sm border border-white/30 hover:bg-white/90 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 shadow-sm hover:shadow-md ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div
                      className={`w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105 flex-shrink-0`}
                    >
                      {feature.icon}
                    </div>
                    <div className="flex-1 px-3 md:px-4 min-w-0">
                      <h3 className="font-bold text-sm md:text-base text-gray-900 group-hover:text-gray-700 transition-colors">
                        {feature.title}
                      </h3>
